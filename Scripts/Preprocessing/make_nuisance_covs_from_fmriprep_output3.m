% this function takes a confounds file generated by fmriprep and creates a  
% nuisance covariate matrix with the following regressors:
%
% 1) spikes for framewise displacement > .25mm. Note that HMPs are filtered
% according to Power 2019 and back-computed to ~2 seconds back, vs. 1 frame
% back
...
% 4) 24 motion covs (based on unfiltered HMPs)
% 5) CSF
% 6) Global Signal
%
