...
function [nuis_matrix, n_spike_regs, n_spike_regs_percent] = make_nuisance_covs_from_fmriprep_output3(fmriprep_confounds_fname, TR, spike_additional_vols, ndummies, fast_TR, varargin)

gs = false; wm = false; csf = false, aCompCor = false; tCompCor = false;
