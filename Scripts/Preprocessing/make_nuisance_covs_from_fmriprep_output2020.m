...
function [nuis_matrix, n_spike_regs, n_spike_regs_percent] = make_nuisance_covs_from_fmriprep_output2020(fmriprep_confounds_fname, TR, FD_spike_cutoff, spike_additional_vols, ndummies, fast_TR, varargin)
...
if any(strcmp(varargin, 'antpost')), antpost = true; end % hack for OLP4CBP study. sorry. Yoni July 2020. Remove later.
