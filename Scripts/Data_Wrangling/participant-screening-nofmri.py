...
def filter_function(df):
    return  (df['consent_to_contact1'] == 1 and
			 ...
			 df['please_select_which_diagno_1'] == 0 and 
			 df['please_select_which_diagno_2'] == 0 and 
			 df['please_select_which_diagno_3'] == 0 and 
			 df['please_select_which_diagno_4'] == 0 and 
			 df['please_select_which_diagno_5'] == 0 and 
			 df['please_select_which_diagno_6'] == 0 and 
			 df['please_select_which_diagno_7'] == 0 and 
			 df['please_select_which_diagno_8'] == 0 and 
			 df['please_select_which_diagno_9'] == 0 and 
			 df['please_select_which_diagno_10'] == 0 and 
			 df['please_select_which_diagno_11'] == 0 and 
